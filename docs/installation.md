...
This installs `.ko` files to `/lib/modules/2.2.2-Hyperion-2.2.2/`.
...
- Copies build artifacts to `/usr/src/linux-headers-2.2.2-Hyperion-2.2.2/`
- Creates the `/lib/modules/2.2.2-Hyperion-2.2.2/build` symlink
...
sudo dkms autoinstall -k 2.2.2-Hyperion-2.2.2
...
# After reboot:
uname -r     # Should show: 2.2.2-Hyperion-2.2.2
uname -a     # Full version string with author credit

# Verify headers are at the correct path
ls /usr/src/linux-headers-2.2.2-Hyperion-2.2.2/

# Verify build symlink
readlink /lib/modules/$(uname -r)/build
# Should show: /usr/src/linux-headers-2.2.2-Hyperion-2.2.2
...
sudo rm -f /boot/vmlinuz-2.2.2-Hyperion-2.2.2
sudo rm -f /boot/initrd.img-2.2.2-Hyperion-2.2.2
sudo rm -f /boot/System.map-2.2.2-Hyperion-2.2.2
sudo rm -f /boot/config-2.2.2-Hyperion-2.2.2

# Remove modules
sudo rm -rf /lib/modules/2.2.2-Hyperion-2.2.2/

# Remove headers
sudo rm -rf /usr/src/linux-headers-2.2.2-Hyperion-2.2.2/

# Update bootloader
sudo update-grub   # or your distro equivalent

# Remove DKMS records for this kernel
sudo dkms remove --all -k 2.2.2-Hyperion-2.2.2
```
